...
- 후기
  * 수업 시간에 배운 내용을 전체적으로 정리하고, 잊고 있었던 부분들을 다시 떠올리며 복습할 수 있었습니다.
  * 정규표현식을 사용하면 대량의 데이터 중에서 특정 규칙을 가진 문자열을 효율적으로 검색하고 추출할 수 있다는 것을 확인했습니다.
  * 4번 단어 검색 기능도 현재는 문자열을 일일이 분리해서 비교하는 방식이지만,
    정규표현식을 활용하여 간단하게 코드를 작성할 수 있는 방법을 고민해 볼 생각입니다.
